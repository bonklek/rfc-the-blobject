...
- [Codex architecture](https://docs.codex.storage/learn/architecture) — duration-priced storage contracts, provider collateral, and randomized proofs of possession during the contract interval.
