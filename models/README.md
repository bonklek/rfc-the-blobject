...
`pricing.py` compares plain byte-time accounting, a convex duration premium, quantized maturities, expected-scarcity pricing, and an auction reserve-price proxy.

```powershell
python models/pricing.py --size 131072 --duration 4096 --utilization 0.75
```
